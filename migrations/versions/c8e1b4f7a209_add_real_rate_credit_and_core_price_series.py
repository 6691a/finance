...
KINDS = ("government_bond", "money_market", "policy_rate", "tips_rate", "credit_spread", "price_index", "activity")
PREVIOUS_KINDS = ("government_bond", "money_market", "policy_rate", "price_index", "activity")
