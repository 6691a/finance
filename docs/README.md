...
| [market-thesis/](analysis/market-thesis/README.md) | 시장 추론 기록. 단계마다 문서 하나 | 14(웹 화면)와 18의 §3(프리마켓)을 뺀 전부 구현 완료. 4(그래프 투영)는 2026-08-30 운영 기동. 17(그래프 조회)은 2026-08-31 구현, 리비전 `d7a41f8b2c93`이 운영 반영 대기. 12(API)는 구현됐고 배포만 14단계와 함께 — 그 README가 원본 |
