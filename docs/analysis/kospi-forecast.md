...
> - 무엇: 하루 세 번(장전·장중·마감전) "오른다/내린다 + 몇 % ± 몇 %"와 이유를 낸다. 장 마감 뒤 AI가 "오늘 무엇이 코스피를 움직였나"를 관찰해 관계 그래프에 쌓고, 코드가 그 관찰에서 요인별 가중치를 계산한다. 결과는 DB와 Slack으로 나간다.
> - 한계: 2026-09-03 오후 급락(일본 금리 루머)은 일본·중국 지수가 요인에 없어 말할 수 없었고, 추가는 판 동결 뒤다. 루머를 미리 맞히는 것은 목표가 아니다. 20영업일 뒤 관계가 수렴하지 않으면 핵심 가정이 틀린 것이고 접는다.

- 날짜: 2026-09-02(작성), 2026-09-03(운영 기동·옛 기능 삭제)
- 상태: **운영 중.** 2026-09-03에 슬롯 셋과 관찰이 돌았고 채점까지 확인했다. 관계 그래프는
  8거래일(8/24~9/2)을 백필해 관측 34건이 쌓였다. 프롬프트 판 5(2026-09-04, §8.8).
