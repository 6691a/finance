...
> **한눈에**
> - 왜: 산업 대표 20사의 새 공시를 2분마다 모으는데 사람이 보는 출구가 없었다. 실적 발표처럼 주가를 바로 움직이는 소식을 알고도 아무에게도 알리지 않았다.
> - 무엇: 평일 07시~20시 50분, 10분마다 새 공시가 있으면 Slack으로 알린다. 전부 싣고 AI는 어느 것이 중요한지 별표와 한 줄 이유만 붙인다. 실적 공시면 매출·영업이익·순이익과 전년 대비를 함께 적는다.
> - 한계: 공시 대상 20사만 다룬다. "이미 보냈나"를 기록하지 않아 재시도 때 같은 알림이 두 번 갈 수 있다. 운영 AI 키가 무효인 상태라 강조는 키가 살아나야 켜진다.
