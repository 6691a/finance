...
`docs/market-thesis/9-intraday.md`가 설계다. 장전 08:35 한 번으로는 09:00 개장 뒤에 나온
공시·기사·수급·가격 움직임이 그날 판단에 전혀 반영되지 않는다. 다음 판단이 다음 날 아침이라
"시장 변화를 따라잡지 못한다"가 이 DAG를 만든 이유다.

**맞고 틀림이 목적이 아니다.** 목적은 "어떤 정보를 근거로 어떤 결론을 냈다"가 기록으로
남는 것이다. 채점은 그 위에 나중에 얹히고, 채점하는 쪽은 `market_thesis_review`다.
