...
def summary_of(thesis: Thesis, grades: tuple[int, int, float | None] = (0, 0, None)) -> ThesisSummary:
    ...
    return ThesisSummary(
        ...
        up_return_band_pct=number(thesis.up_return_band_pct),
        down_return_band_pct=number(thesis.down_return_band_pct),
        base_price=number(thesis.base_price),
        base_at=thesis.base_at,
        base_return_pct=number(thesis.base_return_pct),
...
def outcome_of(
    ...
    *,
    ...
    return ThesisOutcomeItem(
        ...
        predicted_band_pct=number(row.predicted_band_pct),
