...
| [market-thesis/](analysis/market-thesis/README.md) | 시장 추론 기록. 단계마다 문서 하나 | 14(웹 화면)·17(그래프 조회)을 뺀 전부 구현 완료. 4(그래프 투영)는 2026-08-30 운영 기동. 12(API)는 구현됐고 배포만 14단계와 함께 — 그 README가 원본 |
