...
> - 한계: 120영업일에 방향 적중이 61.4% 이하이고 폭 적중이 60% 미만이면 전망을 접고 관찰만 남긴다. 요인 15개 중 7개는 첫날 관측이 0이었다.

- 날짜: 2026-09-04
- 상태: **동결 중.** 운영 기동은 2026-09-03. 2026-09-04에 판 5로 올렸고(아래 §0의 기록)
  20영업일 시계는 거기서 다시 시작한다.
