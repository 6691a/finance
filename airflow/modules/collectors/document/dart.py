...
MATERIAL_REPORT_KEYWORDS: tuple[str, ...] = (
    ...
    "(잠정)실적",
    "기타경영사항",
    # 둘은 2026-09-01~09 운영 실측에서 본문 없이 들어와 코스피 전망의 `recent_disclosures`에
    # 안 보였다(설계 kospi-forecast.md §8.11). 풍문 해명은 회사가 스스로 내는 자율공시라
    # `조회공시`(거래소가 묻는 것) 조각에 안 걸린다. 공급계약은 `단일판매ㆍ공급계약체결`이다.
    "풍문또는보도",
    "공급계약",
)
