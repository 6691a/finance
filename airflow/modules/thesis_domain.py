...
# 7: 신호마다 조건부 기저율이 실린다(2026-08-26). "같은 사건이 과거에 얼마나 맞았는지는
#    너도 시스템도 아직 모른다"를 지우고 실측 분포로 바꿨다. 무조건 기저를 함께 주고 둘의
#    차이가 그 신호의 정보량임을 밝힌다(docs/analysis/market-thesis/10-base-rate.md).
PROMPT_VERSION = "7"
