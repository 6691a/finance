...
지금 여기 있는 것은 네이버 증권 리서치 하나다. 나머지(`collectors/documents.py`의 피드,
`collectors/document_listings.py`의 KRX·금감원, `collectors/dart.py`의 공시)는 아직 옛 자리에
있고, 옮기는 계획은 `docs/collectors-class-migration.md`에 있다.
